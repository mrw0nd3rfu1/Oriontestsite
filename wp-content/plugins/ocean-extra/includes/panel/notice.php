            ...
            <div class="notice notice-success ocean-extra-notice">
                <div class="notice-inner">
                    ...
                    <div class="notice-content">
                        <p><?php
                            printf(
                                __( 'Thank you for using OceanWP, as a gesture of our appreciation, we&rsquo;d like to give you the premium <a href="%1$s" target="_blank">Ocean Hooks</a> extension for free! Simply click the button bellow and complete the fields:', 'ocean-extra' ),
